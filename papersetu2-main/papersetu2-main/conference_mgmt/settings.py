...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'trekeaze@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')   # no default!
DEFAULT_FROM_EMAIL = os.environ.get('EMAIL_HOST_USER', 'trekeaze@gmail.com')
...
SITE_DOMAIN = os.environ.get('SITE_DOMAIN', 'treakeaze.com')
SITE_URL = os.environ.get('SITE_URL', 'https://treakeaze.com')
